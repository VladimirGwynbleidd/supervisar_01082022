...
Public Class ucFiltro3
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Dim controlID As String = "ucFiltro3"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Shared criteriosSeleccion As New List(Of CriterioSeleccion3)
    ...
    Private _ucTemplateControlPath As String = "ASP.controles_filtro3"
    ''' <summary>
    ...
    Private _ucPath As String = "~/Controles/filtro3/"
    ''' <summary>
    ...
    Public Sub AddFilter(ByVal Nombre As String,
        ...
        Dim cs As New CriterioSeleccion3
        cs.Nombre = Nombre
        cs.Tipo = TipoControl
    ...
    Protected Sub ucDropDownList_onDeleteClk(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim ucDropDownList As ddlUserControl3 = DirectCast(DirectCast(sender, System.Web.UI.WebControls.Button).Parent, ddlUserControl3)
        removeControl(ucDropDownList)
    End Sub

    Protected Sub ucDropDownListR_onDeleteClk(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim ucDropDownListR As ddlUserControlR3 = DirectCast(DirectCast(sender, System.Web.UI.WebControls.Button).Parent, ddlUserControlR3)
    ...
    Protected Sub ucTextBox_onPostClk(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim ucTextBox As txtUserControl3 = DirectCast(DirectCast(sender, System.Web.UI.WebControls.Button).Parent, txtUserControl3)
    ...
    Protected Sub ucCalendar_onDeleteClk(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim ucCalendar As cldUserControl3 = DirectCast(DirectCast(sender, System.Web.UI.WebControls.Button).Parent, cldUserControl3)
    ...
    Protected Sub ucRadioButton_onDeleteClk(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim ucRadioButton As rbUserControl3 = DirectCast(DirectCast(sender, System.Web.UI.WebControls.Button).Parent, rbUserControl3)
    ...
    Protected Sub ucCheckList_onDeleteClk(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim ucCheckList As chkUserControl3 = DirectCast(DirectCast(sender, System.Web.UI.WebControls.Button).Parent, chkUserControl3)
    ...
    Private Sub removeControl(ByVal obj As Object)
        ...
        Select Case obj.ToString
            Case _ucTemplateControlPath & "_cldusercontrol3_ascx"
                PlaceHolder1.Controls.Remove(DirectCast(obj, cldUserControl3))
                Session.Remove(DirectCast(obj, cldUserControl3).SessionID)
                ddlAgregar.Items.Add(DirectCast(obj, cldUserControl3).labelText)
            Case _ucTemplateControlPath & "_rbusercontrol3_ascx"
                PlaceHolder1.Controls.Remove(DirectCast(obj, rbUserControl3))
                Session.Remove(DirectCast(obj, rbUserControl3).SessionID)
                ddlAgregar.Items.Add(DirectCast(obj, rbUserControl3).labelText)
            Case _ucTemplateControlPath & "_txtusercontrol3_ascx"
                PlaceHolder1.Controls.Remove(DirectCast(obj, txtUserControl3))
                Session.Remove(DirectCast(obj, txtUserControl3).SessionID)
                ddlAgregar.Items.Add(DirectCast(obj, txtUserControl3).labelText)
            Case _ucTemplateControlPath & "_ddlusercontrol3_ascx"
                PlaceHolder1.Controls.Remove(DirectCast(obj, ddlUserControl3))
                Session.Remove(DirectCast(obj, ddlUserControl3).SessionID)
                ddlAgregar.Items.Add(DirectCast(obj, ddlUserControl3).labelText)
            Case _ucTemplateControlPath & "_ddlusercontrolr3_ascx"
                PlaceHolder1.Controls.Remove(DirectCast(obj, ddlUserControlR3))
                Session.Remove(DirectCast(obj, ddlUserControlR3).SessionID)
                ddlAgregar.Items.Add(DirectCast(obj, ddlUserControlR3).labelText)
            Case _ucTemplateControlPath & "_chkusercontrol3_ascx"
                PlaceHolder1.Controls.Remove(DirectCast(obj, chkUserControl3))
                Session.Remove(DirectCast(obj, chkUserControl3).SessionID)
                ddlAgregar.Items.Add(DirectCast(obj, chkUserControl3).labelText)
    ...
    Private Sub CreateTextbox(
        ...
        Dim ucTextBox As txtUserControl3 = DirectCast(LoadControl(ucPath & "txtUserControl3.ascx"), txtUserControl3)
    ...
    Private Sub CreateDropDownList(
        ...
        'Crea instancia del control
        Dim ucDropDownList As ddlUserControl3 = DirectCast(LoadControl(ucPath & "ddlUserControl3.ascx"), ddlUserControl3)
    ...
    Private Sub CreateDropDownListR(
        ...
        'Crea instancia del control
        Dim ucDropDownListR As ddlUserControlR3 = DirectCast(LoadControl(ucPath & "ddlUserControlR3.ascx"), ddlUserControlR3)
    ...
    Private Sub CreateCalendar(ByVal name As String,
        ...
        'Crea instancia del control
        '----------------------------------------------
        Dim ucCalendar As cldUserControl3 = DirectCast(LoadControl(ucPath & "cldUserControl3.ascx"), cldUserControl3)
    ...
    Private Sub CreateRadioButton(
        ...
        'Crea instancia del control
        Dim ucRadioButton As rbUserControl3 = DirectCast(LoadControl(ucPath & "rbUserControl3.ascx"), rbUserControl3)
    ...
    Private Sub CreateCheckBoxButtom(
        ...
        'Crea instancia del control
        Dim ucCheckBox As chkButtomUserControl3 = DirectCast(LoadControl(ucPath & "chkButtomUserControl3.ascx"), chkButtomUserControl3)
    ...
    Private Sub CreateCheckBox(
        ...
        'Crea instancia del control
        Dim ucCheckBox As chkUserControl3 = DirectCast(LoadControl(ucPath & "chkUserControl3.ascx"), chkUserControl3)
            ...
            If PlaceHolder1 IsNot Nothing Then
                For Each Control As Control In PlaceHolder1.Controls
                    Select Case Control.TemplateControl.ToString
                        Case SessionID & "_txtusercontrol3_ascx"
                            Dim ucTextBox As txtUserControl3 = TryCast(Control, txtUserControl3)
                        ...
                        Case SessionID & "_ddlusercontrol3_ascx"
                            Dim ucDropDownList As ddlUserControl3 = TryCast(Control, ddlUserControl3)
                        ...
                        Case SessionID & "_ddlusercontrolr3_ascx"
                            Dim ucDropDownListR As ddlUserControlR3 = TryCast(Control, ddlUserControlR3)
                        ...
                        Case SessionID & "_cldusercontrol3_ascx"
                            Dim ucCalendar As cldUserControl3 = TryCast(Control, cldUserControl3)
                            ...
                            Else
                                ...
                                End If
                            End If
                        Case SessionID & "_rbusercontrol3_ascx"
                            Dim ucRadioButton As rbUserControl3 = TryCast(Control, rbUserControl3)
                            ...
                            End If
                        Case SessionID & "_chkusercontrol3_ascx"
                            Dim ucCheckBox As chkUserControl3 = TryCast(Control, chkUserControl3)
            ...
            If TableRow2.Cells.Count > 0 Then
                ...
                For Each Control As TableCell In TableRow2.Cells
                    ...
                    Select Case Control.Controls(0).TemplateControl.ToString()
                        Case SessionID & "_chkbuttomusercontrol3_ascx"

                            Dim ucCheckBox As chkButtomUserControl3 = TryCast(Control.Controls(0), chkButtomUserControl3)
                            ucCheckBox.FetchValues()
                            SelValues.Add(ucCheckBox.DataValueField & "=" & Convert.ToInt16(ucCheckBox.selectedValue))
                            FiltroParaSesion.Add(ucCheckBox.labelText, ucCheckBox.selectedValue.ToString())
                    End Select
                    ...
                    For i As Integer = 0 To Session.Count - 1
                        If Session(i) IsNot Nothing Then
                            Select Case Session(i).ToString()
                                Case SessionID & "_txtusercontrol3_ascx"
                                    Dim ucTextBox As txtUserControl3 = TryCast(LoadControl(ucPath & "txtUserControl3.ascx"), txtUserControl3)

                                    ucTextBox.ID = DirectCast(Session(i), txtUserControl3).ID
                                    ucTextBox.SessionID = DirectCast(Session(i), txtUserControl3).SessionID
                                    ucTextBox.labelText = DirectCast(Session(i), txtUserControl3).labelText
                                    ucTextBox.isTextBoxLike = DirectCast(Session(i), txtUserControl3).isTextBoxLike
                                    ucTextBox.isTextBoxRange = DirectCast(Session(i), txtUserControl3).isTextBoxRange
                                    ucTextBox.maxLength = DirectCast(Session(i), txtUserControl3).maxLength

                                    ucTextBox.DataValueField = DirectCast(Session(i), txtUserControl3).DataValueField
                                    ...
                                    If ucTextBox.ID.ToString = CambiaCampoFixed Then
                                        ...
                                        DirectCast(Session(i), txtUserControl3).isFixed = False
                                    Else
                                        ucTextBox.isFixed = DirectCast(Session(i), txtUserControl3).isFixed
                                    End If
                                    ...
                                    Exit Select
                                Case SessionID & "_ddlusercontrol3_ascx"
                                    Dim ucDropDownList As ddlUserControl3 = TryCast(LoadControl(ucPath & "ddlUserControl3.ascx"), ddlUserControl3)


                                    ucDropDownList.DataValueType = DirectCast(Session(i), ddlUserControl3).DataValueType
                                    ucDropDownList.ID = DirectCast(Session(i), ddlUserControl3).ID
                                    ucDropDownList.SessionID = DirectCast(Session(i), ddlUserControl3).SessionID
                                    ucDropDownList.source = DirectCast(Session(i), ddlUserControl3).source
                                    ucDropDownList.DataTextField = DirectCast(Session(i), ddlUserControl3).DataTextField
                                    ucDropDownList.DataValueField = DirectCast(Session(i), ddlUserControl3).DataValueField
                                    ucDropDownList.Bind()
                                    ucDropDownList.labelText = DirectCast(Session(i), ddlUserControl3).labelText

                                    'Si el campo esta marcado como que se forzo a fijo por el filtro solo mio
                                    'indica que es campo no es fijo, por lo cual se asigna como no fijo
                                    If ucDropDownList.ID.ToString = CambiaCampoFixed Then
                                        ucDropDownList.isFixed = False
                                        DirectCast(Session(i), ddlUserControl3).isFixed = False
                                    Else
                                        ucDropDownList.isFixed = DirectCast(Session(i), ddlUserControl3).isFixed
                                    End If

                                    ucDropDownList.selectedValue = DirectCast(Session(i), ddlUserControl3).selectedValue

                                    AddHandler ucDropDownList.btnPostClk, AddressOf ucDropDownList_onDeleteClk
                                    PlaceHolder1.Controls.Add(ucDropDownList)
                                    Exit Select
                                Case SessionID & "_ddlusercontrolr3_ascx"
                                    Dim ucDropDownListR As ddlUserControlR3 = TryCast(LoadControl(ucPath & "ddlUserControlR3.ascx"), ddlUserControlR3)


                                    ucDropDownListR.DataValueType = DirectCast(Session(i), ddlUserControlR3).DataValueType
                                    ucDropDownListR.ID = DirectCast(Session(i), ddlUserControlR3).ID
                                    ucDropDownListR.SessionID = DirectCast(Session(i), ddlUserControlR3).SessionID
                                    ucDropDownListR.source = DirectCast(Session(i), ddlUserControlR3).source
                                    ucDropDownListR.DataTextField = DirectCast(Session(i), ddlUserControlR3).DataTextField
                                    ucDropDownListR.DataValueField = DirectCast(Session(i), ddlUserControlR3).DataValueField
                                    ucDropDownListR.Bind()
                                    ucDropDownListR.labelText = DirectCast(Session(i), ddlUserControlR3).labelText

                                    'Si el campo esta marcado como que se forzo a fijo por el filtro solo mio
                                    'indica que es campo no es fijo, por lo cual se asigna como no fijo
                                    If ucDropDownListR.ID.ToString = CambiaCampoFixed Then
                                        ucDropDownListR.isFixed = False
                                        DirectCast(Session(i), ddlUserControlR3).isFixed = False
                                    Else
                                        ucDropDownListR.isFixed = DirectCast(Session(i), ddlUserControlR3).isFixed
                                    End If

                                    ucDropDownListR.selectedValue = DirectCast(Session(i), ddlUserControlR3).selectedValue
                                ...
                                Case SessionID & "_cldusercontrol3_ascx"
                                    Dim ucCalendar As cldUserControl3 = TryCast(LoadControl(ucPath & "cldUserControl3.ascx"), cldUserControl3)

                                    ucCalendar.ID = DirectCast(Session(i), cldUserControl3).ID
                                    ucCalendar.SessionID = DirectCast(Session(i), cldUserControl3).SessionID
                                    ucCalendar.fechaFin = DirectCast(Session(i), cldUserControl3).fechaFin
                                    ucCalendar.FechaInicio = DirectCast(Session(i), cldUserControl3).FechaInicio

                                    ucCalendar.labelText = DirectCast(Session(i), cldUserControl3).labelText
                                    ucCalendar.isCalendarSingle = DirectCast(Session(i), cldUserControl3).isCalendarSingle
                                    ucCalendar.DataValueField = DirectCast(Session(i), cldUserControl3).DataValueField

                                    'Si el campo esta marcado como que se forzo a fijo por el filtro solo mio
                                    'indica que es campo no es fijo, por lo cual se asigna como no fijo
                                    If ucCalendar.ID.ToString = CambiaCampoFixed Then
                                        ucCalendar.isFixed = False
                                        DirectCast(Session(i), cldUserControl3).isFixed = False
                                    Else
                                        ucCalendar.isFixed = DirectCast(Session(i), cldUserControl3).isFixed
                                    End If
                                    ...
                                    Exit Select
                                Case SessionID & "_rbusercontrol3_ascx"
                                    Dim ucRadioButton As rbUserControl3 = TryCast(LoadControl(ucPath & "rbUserControl3.ascx"), rbUserControl3)

                                    ucRadioButton.ID = DirectCast(Session(i), rbUserControl3).ID
                                    ucRadioButton.SessionID = DirectCast(Session(i), rbUserControl3).SessionID
                                    ucRadioButton.source = DirectCast(Session(i), rbUserControl3).source
                                    ucRadioButton.DataValueField = DirectCast(Session(i), rbUserControl3).DataValueField
                                    ucRadioButton.DataTextField = DirectCast(Session(i), rbUserControl3).DataTextField
                                    ucRadioButton.bind()
                                    ucRadioButton.labelText = DirectCast(Session(i), rbUserControl3).labelText
                                    ucRadioButton.DataValueType = DirectCast(Session(i), rbUserControl3).DataValueType

                                    'Si el campo esta marcado como que se forzo a fijo por el filtro solo mio
                                    'indica que es campo no es fijo, por lo cual se asigna como no fijo
                                    If ucRadioButton.ID.ToString = CambiaCampoFixed Then
                                        ucRadioButton.isFixed = False
                                        DirectCast(Session(i), rbUserControl3).isFixed = False
                                    Else
                                        ucRadioButton.isFixed = DirectCast(Session(i), rbUserControl3).isFixed
                                    End If
                                    ...
                                    Exit Select
                                Case SessionID & "_chkusercontrol3_ascx"
                                    Dim ucCheckList As chkUserControl3 = TryCast(LoadControl(ucPath & "chkUserControl3.ascx"), chkUserControl3)

                                    ucCheckList.ID = DirectCast(Session(i), chkUserControl3).ID
                                    ucCheckList.SessionID = DirectCast(Session(i), chkUserControl3).SessionID
                                    ucCheckList.source = DirectCast(Session(i), chkUserControl3).source
                                    ucCheckList.DataValueField = DirectCast(Session(i), chkUserControl3).DataValueField
                                    ucCheckList.DataTextField = DirectCast(Session(i), chkUserControl3).DataTextField
                                    ucCheckList.bind()
                                    ucCheckList.labelText = DirectCast(Session(i), chkUserControl3).labelText
                                    ucCheckList.DataValueType = DirectCast(Session(i), chkUserControl3).DataValueType

                                    'Si el campo esta marcado como que se forzo a fijo por el filtro solo mio
                                    'indica que es campo no es fijo, por lo cual se asigna como no fijo
                                    If ucCheckList.ID.ToString = CambiaCampoFixed Then
                                        ucCheckList.isFixed = False
                                        DirectCast(Session(i), chkUserControl3).isFixed = False
                                    Else
                                        ucCheckList.isFixed = DirectCast(Session(i), chkUserControl3).isFixed
                                    End If

                                    ucCheckList.selectedValue = DirectCast(Session(i), chkUserControl3).selectedValue
                                ...
                                Case SessionID & "_chkbuttomusercontrol3_ascx"
                                    Dim ucCheckList As chkButtomUserControl3 = TryCast(LoadControl(ucPath & "chkButtomUserControl3.ascx"), chkButtomUserControl3)

                                    ucCheckList.ID = DirectCast(Session(i), chkButtomUserControl3).ID
                                    ucCheckList.SessionID = DirectCast(Session(i), chkButtomUserControl3).SessionID
                                    ucCheckList.source = DirectCast(Session(i), chkButtomUserControl3).source
                                    ucCheckList.DataValueField = DirectCast(Session(i), chkButtomUserControl3).DataValueField
                                    ucCheckList.DataTextField = DirectCast(Session(i), chkButtomUserControl3).DataTextField
                                    ucCheckList.bind()
                                    ucCheckList.labelText = DirectCast(Session(i), chkButtomUserControl3).labelText
                                    ucCheckList.DataValueType = DirectCast(Session(i), chkButtomUserControl3).DataValueType
                                    ucCheckList.isFixed = DirectCast(Session(i), chkButtomUserControl3).isFixed
                                    ucCheckList.selectedValue = DirectCast(Session(i), chkButtomUserControl3).selectedValue
    ...
    Protected Sub ddlAgregar_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlAgregar.SelectedIndexChanged
        Dim result As CriterioSeleccion3 = criteriosSeleccion.Find(AddressOf FindNombre)
    ...
    ''' <remarks></remarks>
    Private Function FindNombre(ByVal cs As CriterioSeleccion3) As Boolean
        ...
        If PlaceHolder1 IsNot Nothing AndAlso Session.Count > 0 Then
            For Each Control As Control In PlaceHolder1.Controls
                Select Case Control.TemplateControl.ToString
                    ...
                    Case SessionID & "_chkusercontrol3_ascx"
                        Dim ucCheckList As chkUserControl3 = TryCast(Control, chkUserControl3)
    ...
    Private Sub CargaValoresFiltro()
        ...
        For Each _control As Control In PlaceHolder1.Controls
            Select Case _control.TemplateControl.ToString
                ...
                Case SessionID & "_txtusercontrol3_ascx"
                    Dim ucTextBox As txtUserControl3 = TryCast(_control, txtUserControl3)
                ...
                Case SessionID & "_rbusercontrol3_ascx"
                    Dim ucRadioButton As rbUserControl3 = TryCast(_control, rbUserControl3)
                    If _filtros.ContainsKey(ucRadioButton.labelText) Then
                        ucRadioButton.selectedValue = _filtros(ucRadioButton.labelText)
                    End If

                Case SessionID & "_chkusercontrol3_ascx"
                    Dim ucCheckButton As chkUserControl3 = TryCast(_control, chkUserControl3)
        ...
        If PlaceHolder1.Controls.Count > 0 Then
            ...
            For Each cntrl In PlaceHolder1.Controls
                Select Case cntrl.TemplateControl.ToString()
                    Case SessionID & "_cldusercontrol3_ascx"
                        Dim ucCalendar As cldUserControl3 = TryCast(cntrl, cldUserControl3)
                    ...
                    Case SessionID & "_txtusercontrol3_ascx"
                        Dim ucTextBox As txtUserControl3 = TryCast(cntrl, txtUserControl3)
                        ucTextBox.FetchValues()
                    ...
                    Case SessionID & "_ddlusercontrol3_ascx"
                        Dim ucDDL As ddlUserControl3 = TryCast(cntrl, ddlUserControl3)
                        ucDDL.FetchValues()
                    ...
                    Case SessionID & "_ddlusercontrolr3_ascx"
                        Dim ucDDL As ddlUserControlR3 = TryCast(cntrl, ddlUserControlR3)
                        ucDDL.FetchValues()
                        If ucDDL.selectedValue = "-1" Or ucDDL.selectedValue = Nothing Then
        ...
        If TableRow2.Cells.Count > 0 Then
            ...
            If PlaceHolder1.Controls.Count = 1 Then
                ...
                Select Case tmpControl.TemplateControl.ToString()
                    Case SessionID & "_cldusercontrol3_ascx"
                        Dim ucCalendar As cldUserControl3 = TryCast(PlaceHolder1.Controls(0), cldUserControl3)
                        If ucCalendar.isFixed = False Then
                            ucCalendar.isFixed = True
                            CambiaCampoFixed = ucCalendar.ID.ToString()
                        End If
                    Case SessionID & "_rbusercontrol3_ascx"
                        Dim ucRadioButton As rbUserControl3 = TryCast(PlaceHolder1.Controls(0), rbUserControl3)
                        If ucRadioButton.isFixed = False Then
                            ucRadioButton.isFixed = True
                            CambiaCampoFixed = ucRadioButton.ID.ToString()
                        End If
                    Case SessionID & "_txtusercontrol3_ascx"
                        Dim ucTextBox As txtUserControl3 = TryCast(PlaceHolder1.Controls(0), txtUserControl3)
                        If ucTextBox.isFixed = False Then
                            ucTextBox.isFixed = True
                            CambiaCampoFixed = ucTextBox.ID.ToString()
                        End If
                    Case SessionID & "_ddlusercontrol3_ascx"
                        Dim ucDDL As ddlUserControl3 = TryCast(PlaceHolder1.Controls(0), ddlUserControl3)
                        If ucDDL.isFixed = False Then
                            ucDDL.isFixed = True
                            CambiaCampoFixed = ucDDL.ID.ToString()
                        End If
                    Case SessionID & "_ddlusercontrolr3_ascx"
                        Dim ucDDL As ddlUserControlR3 = TryCast(PlaceHolder1.Controls(0), ddlUserControlR3)
                        If ucDDL.isFixed = False Then
                            ucDDL.isFixed = True
                            CambiaCampoFixed = ucDDL.ID.ToString()
                        End If
                    Case SessionID & "_chkusercontrol3_ascx"
                        Dim ucCheckBox As chkUserControl3 = TryCast(PlaceHolder1.Controls(0), chkUserControl3)
...
''' </summary>
''' <remarks></remarks>
Friend Class CriterioSeleccion3

    Property DataValueType As ucFiltro3.DataValueType
    ...
    Public Property Source() As Object
        ...
        End Set
    End Property
    Private _Tipo As ucFiltro3.AcceptedControls
    Public Property Tipo As ucFiltro3.AcceptedControls
        Get
            Return _Tipo
        End Get
        Set(ByVal value As ucFiltro3.AcceptedControls)
            _Tipo = value
        End Set
    End Property
