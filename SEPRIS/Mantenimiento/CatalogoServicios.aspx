<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/SiteInterno.Master" CodeBehind="CatalogoServicios.aspx.vb" Inherits="SEPRIS.CatalogoServicios1" %>
    ...
    <asp:UpdatePanel ID="upnlConsulta" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlConsulta" runat="server" Visible="true">
                ...
                <br />
                <cc1:CustomGridView ID="gvConsulta" AllowSorting="True" runat="server" DataKeyNames="N_ID_SERVICIO"
                    ...
                    UnicoEnPantalla="True" WidthScroll="0" AllowPaging="true" PageSize='<%# ObtenerPaginacion() %>'>
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                        ...
                        <asp:BoundField HeaderText="ID" DataField="N_ID_SERVICIO" 
                            SortExpression="N_ID_SERVICIO" >
                            <ItemStyle Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Servicio" DataField="T_DSC_SERVICIO" SortExpression="T_DSC_SERVICIO" />
            ...
            <asp:Panel ID="pnlRegistro" runat="server" Visible="false">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <asp:Label ID="lblTituloRegistro" runat="server" CssClass="TitulosWebProyectos" Text="Alta de Servicio" EnableTheming="false"></asp:Label>
                </div>
                <asp:Panel ID="pnlControles" runat="server">
                    <table>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtServicio" runat="server" CssClass="txt_gral" Width="300px"
                                    ValidationGroup="Forma" MaxLength="100"></asp:TextBox>
                                <asp:CustomValidator ID="cvServicio"
                                        ControlToValidate="txtServicio" ValidationGroup="Forma" ValidateEmptyText="true"
