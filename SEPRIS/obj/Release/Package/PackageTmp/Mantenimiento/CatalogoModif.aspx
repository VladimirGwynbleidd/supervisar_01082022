<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/SiteInterno.Master" CodeBehind="CatalogoModif.aspx.vb" Inherits="SEPRIS.CatalogoModif" %>
                    ...
                    <table runat="server" id="tblContenido" class="forma" width="90%" border="0">
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 523px; height: 24px" colspan="2">
                                ...
                                runat="server" Width="123px" Height="21px" Text="Aceptar" CssClass="botones"></asp:Button>
                                &nbsp;
