<%@ Page Title="" MaintainScrollPositionOnPostback="true"  Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/SiteInterno.Master" CodeBehind="Reporte4.aspx.vb" Inherits="SEPRIS.Reporte4" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   ...
   <script type="text/javascript" src="../Scripts/funcion3.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div id="divMensajeUnBotonNoAccion" style="display: none" title="Información">
    ...
    <div id="tab1" class="tab_content" style="width: 100%; border: 1px solid #999; font-family: Verdana; font-size: 0.9em; padding: 0px; height: auto;">
            ...
            <ContentTemplate>
               ...
               <table>
                  ...
                  <tr>
                     ...
                     <td>
                        &nbsp;&nbsp;&nbsp;<asp:CheckBox ID="chkGrafica4" Text="Total de Visitas por Tipo de Visita y Área" runat="server" AutoPostBack="true" Checked="true"/>
                     </td>
                  </tr>
                  <tr>
                     <td>
       ...
       <span id="listaTipoVisArea" runat="server" visible="true" ></span>
      <%-- MCS Grafo --%>
