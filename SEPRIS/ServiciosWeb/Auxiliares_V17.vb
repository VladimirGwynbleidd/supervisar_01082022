   ...
   Public Function datosCapturadosValidos(piIVisitaSisvig As Integer,
      ...
      If piIdEntidad > 0 Then
         If piBanEstaInsertando = Constantes.Verdadero Then
            ''Se esta insertando
            If ConsultaDocumentosObligatoriosSinCargarPorPasoUsuario("", PasoProcesoVisita.Pasos.Cero, Constantes.Obligatorio.Obligatorios, , , piIVisitaSisvig) Then
               Return 2140
            End If
         End If
      End If
