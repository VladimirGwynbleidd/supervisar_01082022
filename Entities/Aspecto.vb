...
Public Class Aspecto
    Private Tabla As String = "BDS_C_GR_ENCUESTA_ASPECTOS_EVALUAR"
#Region "Propiedades"
...
#Region "Constructores"
    ...
    Public Sub New(ByVal idAspecto As Integer)
        Me.Identificador = idAspecto
        CargarDatos()
    End Sub
...
#Region "Metodos"
    ...
    Public Sub CargarDatos()
        ...
        Try
            ...
            listCampos.Add("N_ID_ENCUESTA_ASPECTO_EVALUAR") : listValores.Add(Me.Identificador)
            ...
            Try
                ...
                If Existe Then
                    ...
                    If dr.Read() Then
                        Me.Descripcion = CStr(dr("T_DSC_ASPECTO_EVALUAR"))
    ...
    Public Function ObtenerSiguienteIdentificador() As Integer
        ...
        Try
            ...
            Dim dr As SqlClient.SqlDataReader = conexion.ConsultarDR("SELECT (MAX(N_ID_ENCUESTA_ASPECTO_EVALUAR) + 1) N_ID_ENCUESTA_ASPECTO_EVALUAR FROM " + Tabla)

            If dr.Read() Then

                If IsDBNull(dr("N_ID_ENCUESTA_ASPECTO_EVALUAR")) Then
                    resultado = 1
                Else
                    resultado = CInt(dr("N_ID_ENCUESTA_ASPECTO_EVALUAR"))
                End If
    ...
    Public Function Agregar() As Boolean
        ...
        Dim bitacora As New Conexion.Bitacora("Registro de nuevo Aspecto", System.Web.HttpContext.Current.Session.SessionID, CType(System.Web.HttpContext.Current.Session(Entities.Usuario.SessionID), Entities.Usuario).IdentificadorUsuario)
        ...
        Try
            ...
            listCampos.Add("N_ID_ENCUESTA_ASPECTO_EVALUAR") : listValores.Add(Me.Identificador)
            listCampos.Add("T_DSC_ASPECTO_EVALUAR") : listValores.Add(Me.Descripcion)
    ...
    Public Function Actualizar() As Boolean
        ...
        Dim conexion As New Conexion.SQLServer
        Dim bitacora As New Conexion.Bitacora("Actualización de Aspecto", System.Web.HttpContext.Current.Session.SessionID, CType(System.Web.HttpContext.Current.Session(Entities.Usuario.SessionID), Entities.Usuario).IdentificadorUsuario)
        Try
            ...
            listCamposCondicion.Add("N_ID_ENCUESTA_ASPECTO_EVALUAR") : listValoresCondicion.Add(Me.Identificador)
    ...
    Public Function Baja() As Boolean
        ...
        Dim conexion As New Conexion.SQLServer
        Dim bitacora As New Conexion.Bitacora("Borrar Aspecto", System.Web.HttpContext.Current.Session.SessionID, CType(System.Web.HttpContext.Current.Session(Entities.Usuario.SessionID), Entities.Usuario).IdentificadorUsuario)
        Try
