...
#End Region
    ...
    Public Sub SubMenu()
        Dim catalogo As New Entities.Catalogos
        Dim arrLista As New ArrayList
        'Try

        Dim dv As DataView = catalogo.ObtenerTodos()
        ...
        If Not IsNothing(Session(Entities.Usuario.SessionID)) Then
            ...
            If dv.Count > 0 Then
                For Each fila As DataRow In dv.ToTable.Rows
                    ...
                    arr(0) = fila("N_ID_CAT_ADMBLE").ToString()
                    arr(1) = fila("T_DSC_CAT_ADMBLE").ToString()
                    arrLista.Add(arr)
                Next
                ...
                With HttpContext.Current.Response
                    ...
                    For Each Menu In arrLista
                        ...
                        .Write("onclick=""location.href='Catalogo.aspx?catalogo=" & Menu(0) & "'"" align=""left"">" & Menu(1))
                        .Write("</td>")
                        .Write("</Tr>")
                        .Write("</table>")
                        .Write("</td>")
