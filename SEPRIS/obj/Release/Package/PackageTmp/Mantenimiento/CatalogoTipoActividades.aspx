<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/SiteInterno.Master" CodeBehind="CatalogoTipoActividades.aspx.vb" Inherits="SEPRIS.CatalogoTipoActividades" %>
    ...
    <asp:UpdatePanel ID="upnlConsulta" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlConsulta" runat="server" Visible="true">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <label class="TitulosWebProyectos">
                        Catálogo de Tipo de Actividades</label>
                </div>
                ...
                <br />
                <cc1:CustomGridView ID="gvConsulta" AllowSorting="true" runat="server" DataKeyNames="N_ID_TIPO_ACTIVIDAD"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="ID" DataField="N_ID_TIPO_ACTIVIDAD" SortExpression="N_ID_TIPO_ACTIVIDAD" >
                            <ItemStyle Width="50px" />
                            <HeaderStyle Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Descripción" DataField="T_DSC_TIPO_ACTIVIDAD" SortExpression="T_DSC_TIPO_ACTIVIDAD" >
                            <ItemStyle CssClass="Wrap" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Requiere Autorización" SortExpression="B_FLAG_REQUIERE_AUTORIZACION" >
                            <ItemTemplate>
                                <asp:Label ID="lblAutorizacion" runat="server" Text='<%# ObtenerMensajeAutorizacion(DataBinder.Eval(Container.DataItem, "B_FLAG_REQUIERE_AUTORIZACION"))  %>'></asp:Label>
                            </ItemTemplate>
            ...
            <asp:Panel ID="pnlRegistro" runat="server" Visible="false">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <asp:Label ID="lblTituloRegistro" runat="server" CssClass="TitulosWebProyectos" Text="Alta de Tipo de Actividad" EnableTheming="false"></asp:Label>
                </div>
                <asp:Panel ID="pnlControles" runat="server">
                    <table>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtTipoActividad" runat="server" CssClass="txt_gral" Width="300px"
                                    ValidationGroup="Forma" MaxLength="50"></asp:TextBox>
                                <asp:CustomValidator ID="cvTipoActividad"
                                        ControlToValidate="txtTipoActividad" ValidationGroup="Forma" ValidateEmptyText="true"
                        ...
                        <tr>
                            <td align="right">
                                <label class="txt_gral">
                                    Requiere Autorización:</label>
                            </td>
                            <td align="left">
                                <asp:CheckBox ID="chkRequiereAutorizacion" runat="server" class="txt_gral" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
