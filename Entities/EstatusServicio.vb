...
'- Empresa: Softtek
'- Clase para Estatus de Servicio

<Serializable()>
Public Class EstatusServicio

    Private Tabla As String = "BDS_C_GR_ESTATUS_SERVICIO"

#Region "Propiedades"

    Public Property Identificador As Integer
    Public Property Descripcion As String
    Public Property EstatusSolicitud As Boolean
...
#Region "Constructores"
    ...
    Public Sub New(ByVal idEstatusServicio As Integer)
        Me.Identificador = idEstatusServicio
...
#Region "Metodos"
    ...
    ''' <summary>
    ''' Carga los datos del Estatus de Servicio tomando el Identificador almacenado en la propiedad
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub CargarDatos()
        ...
        Try
            ...
            listCampos.Add("N_ID_ESTATUS_SERVICIO") : listValores.Add(Me.Identificador)
            ...
            Try
                ...
                If Existe Then
                    ...
                    If dr.Read() Then
                        Me.Descripcion = CStr(dr("T_DSC_ESTATUS_SERVICIO"))
                        Me.EstatusSolicitud = Convert.ToBoolean(dr("B_FLAG_ESTATUS_SOLICITUD"))
    ...
    Public Function ObtenerSiguienteIdentificador() As Integer
        ...
        Try
            ...
            Dim dr As SqlClient.SqlDataReader = conexion.ConsultarDR("SELECT (MAX(N_ID_ESTATUS_SERVICIO) + 1) N_ID_ESTATUS_SERVICIO FROM " + Tabla)

            If dr.Read() Then

                If IsDBNull(dr("N_ID_ESTATUS_SERVICIO")) Then
                    resultado = 1
                Else
                    resultado = CInt(dr("N_ID_ESTATUS_SERVICIO"))
                End If
    ...
    Public Function Agregar() As Boolean
        ...
        Try
            ...
            listCampos.Add("N_ID_ESTATUS_SERVICIO") : listValores.Add(Me.Identificador)
            listCampos.Add("T_DSC_ESTATUS_SERVICIO") : listValores.Add(Me.Descripcion)
            listCampos.Add("B_FLAG_ESTATUS_SOLICITUD") : listValores.Add(Me.EstatusSolicitud)
    ...
    Public Function Actualizar() As Boolean
        ...
        Dim conexion As New Conexion.SQLServer
        Dim bitacora As New Conexion.Bitacora("Actualización de Estatus de Servicio", System.Web.HttpContext.Current.Session.SessionID, CType(System.Web.HttpContext.Current.Session(Entities.Usuario.SessionID), Entities.Usuario).IdentificadorUsuario)
        Try
            ...
            listCamposCondicion.Add("N_ID_ESTATUS_SERVICIO") : listValoresCondicion.Add(Me.Identificador)
