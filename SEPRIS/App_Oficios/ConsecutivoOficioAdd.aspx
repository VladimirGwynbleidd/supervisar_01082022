<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ConsecutivoOficioAdd.aspx.vb" Inherits="SICOD.ConsecutivoOficioAdd" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <center>
        <asp:Label ID="lblTitulo" runat="server" Text="Consecutivo Oficios Agregar" CssClass="TitulosWebProyectos"></asp:Label>
    </center>
        <br />
