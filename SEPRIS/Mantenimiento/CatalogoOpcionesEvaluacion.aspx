<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/SiteInterno.Master" CodeBehind="CatalogoOpcionesEvaluacion.aspx.vb" Inherits="SEPRIS.CatalogoOpcionesEvaluacion" %>
...
<asp:UpdatePanel ID="upnlConsulta" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlConsulta" runat="server" Visible="true">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <label class="TitulosWebProyectos">
                        Catálogo de Opciones de Evaluación</label>
                </div>
                ...
                <br />
                <cc1:CustomGridView ID="gvConsulta" AllowSorting="True" runat="server" DataKeyNames="N_ID_ENCUESTA_OPCION"
                    Width="100%" ColumnasCongeladas="0" 
                    DataBindEnPostBack="True" HabilitaScroll="False" HabilitaSeleccion="No" 
                    HeigthScroll="0" Text="[gvConsulta]" ToolTip="" ToolTipHabilitado="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="ID" DataField="N_ID_ENCUESTA_OPCION" 
                            SortExpression="N_ID_ENCUESTA_OPCION" >
                ...
                <img id="Noexisten" runat="server" src="../Imagenes/No%20Existen.gif" visible="false" alt="No existen Registros para la Consulta" />
            ...
            <asp:Panel ID="pnlRegistro" runat="server" Visible="false">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <asp:Label ID="lblTituloRegistro" runat="server" CssClass="TitulosWebProyectos" Text="Alta de Opción a Evaluar" EnableTheming="false"></asp:Label>
                </div>
                <asp:Panel ID="pnlControles" runat="server">
                    <table>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtOpcion" runat="server" CssClass="txt_gral" Width="300px"
                                    ValidationGroup="Forma" MaxLength="50"></asp:TextBox>
                                <asp:CustomValidator ID="cvOpcion"
                                        ControlToValidate="txtOpcion" ValidationGroup="Forma" ValidateEmptyText="true"
