<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/SiteInterno.Master" CodeBehind="CatalogoTipoServicio.aspx.vb" Inherits="SEPRIS.CatalogoTipoServicio" %>
    ...
    <asp:UpdatePanel ID="upnlConsulta" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlConsulta" runat="server" Visible="true">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <label class="TitulosWebProyectos">
                        Catálogo de Tipo de Servicio</label>
                </div>
                ...
                <br />
                <cc1:CustomGridView ID="gvConsulta" AllowSorting="true" runat="server" DataKeyNames="N_ID_TIPO_SERVICIO"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="ID" DataField="N_ID_TIPO_SERVICIO" SortExpression="N_ID_TIPO_SERVICIO" >
                            <ItemStyle Width="50px" />
                            <HeaderStyle Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Descripción" DataField="T_DSC_TIPO_SERVICIO" SortExpression="T_DSC_TIPO_SERVICIO" >
            ...
            <asp:Panel ID="pnlRegistro" runat="server" Visible="false">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <asp:Label ID="lblTituloRegistro" runat="server" CssClass="TitulosWebProyectos" Text="Alta de Tipo de Servicio" EnableTheming="false"></asp:Label>
                </div>
                <asp:Panel ID="pnlControles" runat="server">
                    <table>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtTipoServicio" runat="server" CssClass="txt_gral" Width="300px"
                                    ValidationGroup="Forma" MaxLength="50"></asp:TextBox>
                            </td>
                            <td>
                                <asp:CustomValidator ID="cvTipoServicio"
                                        ControlToValidate="txtTipoServicio" ValidationGroup="Forma" ValidateEmptyText="true"
                        ...
                        <tr id="trImagenCatalogo" runat="server">
                            ...
                            <td align="left">
                                <cc1:CustomGridView ID="gvImagen" runat="server" AllowSorting="true" DataKeyNames="N_ID_IMAGEN"
