Imports LogicaNegocio.Entities
Imports LogicaNegocio.BusinessRules

Public Class PersonalizarColumasOfi
    ...
    Protected Sub btnGuardar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnGuardar.Click
        ...
        Try
            ...
            Dim objCamposConsulta As New LogicaNegocio.Entities.BDA_CAMPOS_CONSULTA()
            ...
            If lbxAsignado.Items.Count > 0 Then
                For totalCampos = 0 To lbxAsignado.Items.Count - 1
                    ...
                    LogicaNegocio.BusinessRules.BDA_CAMPOS_CONSULTA.Update(objCamposConsulta)
                Next
            End If
...
#End Region
    ...
    Protected Function UsuarioTieneColumnas(ByVal Usuario As String, ByVal tipoConsulta As Integer) As Boolean
        Return LogicaNegocio.BusinessRules.BDA_CAMPOS_CONSULTA.ConsultaUsuarioTieneColumnasAsignadas(tipoConsulta, Usuario)
    End Function
        ...
        Try
            ...
            If Not UsuarioTieneColumnas(Usuario, tipoConsulta) Then
                ...
                For Each row As DataRow In dt.Rows
                    ...
                    LogicaNegocio.BusinessRules.BDA_CAMPOS_CONSULTA.Insert(objCamposConsulta)
                Next
            End If
    ...
    Function ReturnColumnasPersonalizada(ByVal Usuario As String, ByVal tipoConsulta As Integer) As DataView
        Try
            ...
            dtTable = LogicaNegocio.BusinessRules.BDA_CAMPOS_CONSULTA.ConsultaListaCampos(tipoConsulta, Usuario)
    ...
    Function ReturnColumnasPorConsulta(ByVal tipoConsulta As Integer) As DataTable
        Try
            Dim dtTable As DataTable = New DataTable
            dtTable = LogicaNegocio.BusinessRules.BDA_CAMPOS_CONSULTA.ConsultaListaConsulta(tipoConsulta)
            Return dtTable
        Catch ex As Exception
