<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="cldUserControlOfi.ascx.vb" Inherits="SEPRIS.cldUserControlOfi" %>
    ...
    <tr>
        ...
        <td align="left">
            <div style="width: 72px">
                <asp:Image ID="imgFec3" runat="server" src="~/Procesos/Bandejas_SICOD/OFICIOS/UserControls/filtro/imagenes/Calendar.GIF"
                    Style="cursor: hand" 
                    ImageUrl="~/Procesos/Bandejas_SICOD/OFICIOS/UserControls/filtro/imagenes/Calendar.GIF" />
            </div>
        </td>
        <td align="left">
            <div style="width: 160px">
        ...
        <td align="left">
            <div style="width: 71px">
                <asp:Image ID="imgFec2" runat="server" src="~/Procesos/Bandejas_SICOD/OFICIOS/UserControls/filtro/imagenes/Calendar.gif"
                    Style="cursor: hand" ImageUrl="~/Procesos/Bandejas_SICOD/OFICIOS/UserControls/filtro/imagenes/Calendar.GIF" />
            </div>
        </td>
