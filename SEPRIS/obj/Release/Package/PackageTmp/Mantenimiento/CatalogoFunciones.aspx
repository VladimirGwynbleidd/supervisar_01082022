<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/SiteInterno.Master" CodeBehind="CatalogoFunciones.aspx.vb" Inherits="SEPRIS.CatalogoFunciones" %>
    ...
    <asp:UpdatePanel ID="upnlConsulta" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlConsulta" runat="server" Visible="true">
                ...
                <br />
                <cc1:CustomGridView ID="gvConsulta" AllowSorting="true" runat="server" DataKeyNames="N_ID_FUNCION"
                    Width="100%">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                        ...
                        <asp:BoundField HeaderText="ID" DataField="N_ID_FUNCION" SortExpression="N_ID_FUNCION" >
                            <ItemStyle Width="50px" />
                            <HeaderStyle Width="50px" />
                        </asp:boundfield>
                        <asp:BoundField HeaderText="Descripción" DataField="T_DSC_FUNCION" SortExpression="T_DSC_FUNCION" />
            ...
            <asp:Panel ID="pnlRegistro" runat="server" Visible="false">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <asp:Label ID="lblTituloRegistro" runat="server" CssClass="TitulosWebProyectos" Text="Alta de Función" EnableTheming="false"></asp:Label>
                </div>
                <asp:Panel ID="pnlControles" runat="server">
                    <table>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtFuncion" runat="server" CssClass="txt_gral" Width="300px"
                                    ValidationGroup="Forma" MaxLength="50"></asp:TextBox><asp:CustomValidator ID="cvFuncion"
                                        ControlToValidate="txtFuncion" ValidationGroup="Forma" ValidateEmptyText="true"
