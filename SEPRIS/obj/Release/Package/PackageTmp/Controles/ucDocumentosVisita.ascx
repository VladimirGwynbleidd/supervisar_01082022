...
<script type="text/javascript">
    ...
    function llamaPostbackBuscar() {
        jsShowWindowLoad("Procesando....");
        $("#<%=btnRecargarGrid.ClientID%>").click();
    }
...
<asp:UpdatePanel ID="upGridDocs" runat="server" UpdateMode="Always">
    <ContentTemplate>
        ...
        <asp:Button ID="btnRecargarGrid" runat="server" OnClick="btnRecargarGrid_Click" ClientIDMode="Static" Style="display: none" />
