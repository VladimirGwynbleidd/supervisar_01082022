...
#Region "Carga Datos"
    ...
    Private Sub CargarFiltros()
        ...
        ucFiltro1.AddFilter("ID", ucFiltro.AcceptedControls.TextBox, Nothing, "", "N_ID_FUNCION", ucFiltro.DataValueType.IntegerType, False, False, False, False, , , 4)
        ucFiltro1.AddFilter("Descripción", ucFiltro.AcceptedControls.TextBox, Nothing, "", "T_DSC_FUNCION", ucFiltro.DataValueType.StringType, False, True, False, , , , 255)
        ucFiltro1.LoadDDL("CatalogoFunciones.aspx")
    ...
    Private Sub CargarCatalogo()
        ...
        Dim dv As DataView = objFuncion.ObtenerTodos()
...
#Region "Eventos Controles"
    ...
    Protected Sub btnAgregar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAgregar.Click
        ...
        lblTituloRegistro.Text = "Alta de Función"

        Dim objFuncion As New Funcion()

        txtID.Text = objFuncion.ObtenerSiguienteIdentificador.ToString
    ...
    Protected Sub btnAceptar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAceptar.Click
        ...
        Dim objFuncion As New Funcion(Convert.ToInt32(txtID.Text))

        If Not objFuncion.Existe Then
            Dim errores As New Entities.EtiquetaError(73)
            Mensaje = errores.Descripcion
            imgDosBotonesUnaAccion.ImageUrl = Entities.Imagen.RutaCarpeta & errores.Imagen.Ruta
        Else
            Dim errores As New Entities.EtiquetaError(74)
            Mensaje = errores.Descripcion
            imgDosBotonesUnaAccion.ImageUrl = Entities.Imagen.RutaCarpeta & errores.Imagen.Ruta
        End If
    ...
    Protected Sub btnModificar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnModificar.Click
        ...
        lblTituloRegistro.Text = "Modificación de Función"

        If gvConsulta.SelectedIndex = -1 Then
            Dim errores As New Entities.EtiquetaError(77)
            Mensaje = errores.Descripcion
        ...
        Dim objFuncion As New Funcion(CInt(gvConsulta.DataKeys(gvConsulta.SelectedIndex)("N_ID_FUNCION").ToString()))

        If Not objFuncion.Vigente Then
            Dim errores As New Entities.EtiquetaError(78)
            Mensaje = errores.Descripcion
            imgUnBotonNoAccion.ImageUrl = Entities.Imagen.RutaCarpeta & errores.Imagen.Ruta
            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Mostraremos", "AquiMuestroMensaje();", True)
            Exit Sub
        Else
            txtID.Text = objFuncion.Identificador
    ...
    Protected Sub btnCancelar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCancelar.Click
        ...
        Dim errores As New Entities.EtiquetaError(75)
        Mensaje = errores.Descripcion
        imgDosBotonesUnaAccion.ImageUrl = Entities.Imagen.RutaCarpeta & errores.Imagen.Ruta
        ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Confirmacion", "MensajeConfirmacion();", True)
    ...
    Protected Sub btnEliminar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnEliminar.Click
        ...
        Dim errores
        If gvConsulta.SelectedIndex = -1 Then
            errores = New Entities.EtiquetaError(77)
            Mensaje = errores.Descripcion
            imgUnBotonNoAccion.ImageUrl = Entities.Imagen.RutaCarpeta & errores.Imagen.Ruta
            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Mostraremos", "AquiMuestroMensaje();", True)
            Exit Sub
        ...
        If Not objFuncion.Vigente Then
            errores = New Entities.EtiquetaError(78)
            Mensaje = errores.Descripcion
            imgUnBotonNoAccion.ImageUrl = Entities.Imagen.RutaCarpeta & errores.Imagen.Ruta
            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Mostraremos", "AquiMuestroMensaje();", True)
            Exit Sub
        ...
        errores = New Entities.EtiquetaError(76)
        Mensaje = errores.Descripcion
        imgDosBotonesUnaAccion.ImageUrl = Entities.Imagen.RutaCarpeta & errores.Imagen.Ruta
    ...
    Protected Sub btnAceptarM2B1A_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAceptarM2B1A.Click
        ...
        Select Case btnAceptarM2B1A.CommandArgument
            ...
            Case "btnAceptar"
                ...
                Dim objFuncion As New Funcion(Convert.ToInt32(txtID.Text))
                objFuncion.Descripcion = txtFuncion.Text

                If Not objFuncion.Existe Then
                    objFuncion.Identificador = objFuncion.ObtenerSiguienteIdentificador()
                    objFuncion.Agregar()
                Else
                    objFuncion.Actualizar()
                End If
    ...
    Protected Sub btnConsulta_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnConsulta.Click
        ...
        lblTituloRegistro.Text = "Consulta de Función"

        Dim index As Integer = Convert.ToInt32(Request("__EVENTARGUMENT"))

        Dim objFuncion As New Funcion(CInt(gvConsulta.DataKeys(index)("N_ID_FUNCION").ToString()))

        txtID.Text = objFuncion.Identificador.ToString
        txtFuncion.Text = objFuncion.Descripcion
    ...
    Protected Sub btnExportaExcel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExportaExcel.Click
        ...
        utl.ExportaGrid(dt, gvConsulta, "Catálogo de Funciones", referencias)
    End Sub
...
#Region "Validaciones"
    ...
    Private Sub cvTipoFuncion_ServerValidate(ByVal source As Object, ByVal args As System.Web.UI.WebControls.ServerValidateEventArgs) Handles cvFuncion.ServerValidate
        If txtFuncion.Text.Trim() = String.Empty Then
            Dim errores As New Entities.EtiquetaError(79)
