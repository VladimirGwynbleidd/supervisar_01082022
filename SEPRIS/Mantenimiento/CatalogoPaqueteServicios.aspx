<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/SiteInterno.Master" CodeBehind="CatalogoPaqueteServicios.aspx.vb" Inherits="SEPRIS.CatalogoGrupoServicios" %>
    ...
    <asp:UpdatePanel ID="upnlConsulta" runat="server">
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlConsulta" runat="server" Visible="true">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <label class="TitulosWebProyectos">
                        Catálogo de Paquete de Servicios</label>
                </div>
                ...
                <br />
                <cc1:CustomGridView ID="gvConsulta" runat="server" DataKeyNames="N_ID_GRUPO_SERVICIO" Width="100%"
                    AllowSorting="true">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                        ...
                        <asp:BoundField HeaderText="ID" DataField="N_ID_GRUPO_SERVICIO" SortExpression="N_ID_GRUPO_SERVICIO" >
                            <ItemStyle Width="50px" />
                            <HeaderStyle Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Descripción" DataField="T_DSC_GRUPO_SERVICIO" SortExpression="T_DSC_GRUPO_SERVICIO" ItemStyle-CssClass="Wrap" />
            ...
            <asp:Panel ID="pnlRegistro" runat="server" Visible="false">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <asp:Label ID="lblTituloRegistro" runat="server" CssClass="TitulosWebProyectos" Text="Alta de Paquete de Servicio" EnableTheming="false"></asp:Label>
                </div>
                <asp:Panel ID="pnlControles" runat="server">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CustomValidator
                                    ID="cvDescripcion" ControlToValidate="txtDescripcion" ValidationGroup="Forma"
