<%@ Page Title="" MaintainScrollPositionOnPostback="true"  Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/SiteInterno.Master" CodeBehind="Reporte2.aspx.vb" Inherits="SEPRIS.Reporte2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div id="divMensajeUnBotonNoAccion" style="display: none" title="Información">
    ...
    <div id="tab1" class="tab_content" style="width: 100%; border: 1px solid #999; font-family: Verdana; font-size: 0.9em; padding: 0px; height: auto;">
            ...
            <ContentTemplate>
               ...
               <table>
                  ...
                  <tr>
                     ...
                     <td>
                        &nbsp;&nbsp;&nbsp;<asp:CheckBox ID="chkGrafica2" Text="Total de Visitas por Área y Estatus" runat="server" AutoPostBack="true" Checked="true" />
                     </td>
                     <td>
       ...
       <span id="listaAreasEstatus" runat="server" visible="true" ></span>
      <%-- MCS Grafo --%>
