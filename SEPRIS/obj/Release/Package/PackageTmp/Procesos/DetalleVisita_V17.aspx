...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="dvFechaConvocatoriaAgendar_P11" style="display: none;" title="Confirmación">
        <table width="100%">
            <tr>
                ...
                <td style="text-align: left">
                    <div class="MensajeModal-UI">
                        <%--SE MODIFICA GP AL PASO ACTUAL DE 9.1 A 8.1--%>
    ...
    <asp:Button runat="server" ID="btnCancelarFechaPaso7" Style="display: none" ClientIDMode="Static" OnClick="btnCancelarFechaPaso7_Click" />
    <asp:Button runat="server" ID="btnCambioNormativaLimpiar" Style="display: none" ClientIDMode="Static" OnClick="btnCambioNormativaLimpiar_Click" />
    ...
    <script type="text/javascript">
        ...
        function SolicitarFechaReunionEntidad() {
            ...
            //$("#MainContent_lblFechaGeneral").val("");
        ...
        function MostrarMensajeSISAN(folio) {
            ...
            if (folio.indexOf("Error") == -1) {
                var separa = folio.split("|");
                var folio1 = "";
                for (i = 0; i < separa.length; i++) {
                    folio1 = folio1 + "<br/>" + separa[i];
                }
                document.getElementById('lblMensajeSISAN').innerHTML = "Se ha registrado correctamente en SISAN con  el número de Folio:" + folio1 + '.'
                esRegistroExitoso = 1;
            }
            else {
