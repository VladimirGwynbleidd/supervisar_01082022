<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/SiteInterno.Master" CodeBehind="CatalogoAspectosEvaluar.aspx.vb" Inherits="SEPRIS.CatalogoAspectosEvaluar" %>
...
<asp:UpdatePanel ID="upnlConsulta" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlConsulta" runat="server" Visible="true">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <label class="TitulosWebProyectos">
                        Catálogo de Aspectos a Evaluar</label>
                </div>
                ...
                <br />
                <cc1:CustomGridView ID="gvConsulta" AllowSorting="True" runat="server" DataKeyNames="N_ID_ENCUESTA_ASPECTO_EVALUAR"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="ID" DataField="N_ID_ENCUESTA_ASPECTO_EVALUAR" 
                            SortExpression="N_ID_ENCUESTA_ASPECTO_EVALUAR" >
            ...
            <asp:Panel ID="pnlRegistro" runat="server" Visible="false">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <asp:Label ID="lblTituloRegistro" runat="server" CssClass="TitulosWebProyectos" Text="Alta de Aspecto a Evaluar" EnableTheming="false"></asp:Label>
                </div>
                <asp:Panel ID="pnlControles" runat="server">
                    <table>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtAspecto" runat="server" CssClass="txt_gral" Width="300px"
                                    ValidationGroup="Forma" MaxLength="50"></asp:TextBox>
                                <asp:CustomValidator ID="cvAspecto"
                                        ControlToValidate="txtAspecto" ValidationGroup="Forma" ValidateEmptyText="true"
