<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/SiteInterno.Master" CodeBehind="CatalogoFuncionesGrupo.aspx.vb" Inherits="SEPRIS.CatalogoFuncionesGrupo" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlConsulta" runat="server" Visible="true">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <label class="TitulosWebProyectos" enabletheming="false">Catálogo Funciones de Grupo</label>
                </div>
                <br />
                <table align="center">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlGrupo" runat="server" AutoPostBack="true"  CssClass="txt_gral" Width="200px">
                            </asp:DropDownList>
                            <asp:CustomValidator ID="cvGrupo" ControlToValidate="ddlGrupo" ValidationGroup="Forma" ValidateEmptyText="true"
                                runat="server" EnableClientScript="false" Display="Dynamic" ForeColor="Red">*</asp:CustomValidator>
                        </td>
                    </tr>
                </table>
                <br />
                <asp:Panel ID="pnlFuncion" runat="server" style="display: none">
                    <table align="center">
                        <tr>
                            <td valign="top" style="width: 300px;">
                                <asp:Button ID="btnExportaExcelAsigandos" runat="server" Text="Exportar a Excel"  />
                                <asp:Label ID="lblAsignados" runat="server" Text="Funciones actualmente usadas por el grupo" CssClass="txt_gral" ></asp:Label>
                            </td>
                            <td>
                                &nbsp;
                            </td>
                            <td valign="top" style="width: 300px;">
                                ...
                                <asp:Label ID="lblDisponibles" runat="server" Text="Funciones disponibles para agregar" CssClass="txt_gral"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" style="width: 300px;">                                                                
                                <cc1:CustomGridView ID="gvAsignados" runat="server" Width="300px" SkinID="SeleccionMultipleCliente"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Función" DataField="Descripcion" /> 
                                    </Columns>
                                </cc1:CustomGridView>
                ...
                <table align="center">
                    <tr>
                        <td>
                            <asp:Button runat="server" ID="btnMostrarMensaje"  Text="Aceptar" 
                                Visible="False"  />  
