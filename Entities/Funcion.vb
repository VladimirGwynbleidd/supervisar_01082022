...
'- Empresa: Softtek
'- Clase para Catálogo De Funciones

<Serializable()> _
Public Class Funcion
    Private Tabla As String = "BDS_C_GR_FUNCION"
...
#Region "Constructores"
    ...
    Public Sub New(ByVal idFuncion As Integer)
        Me.Identificador = idFuncion
...
#Region "Metodos"
    ...
    Public Sub CargarDatos()
        ...
        Try
            ...
            listCampos.Add("N_ID_FUNCION") : listValores.Add(Me.Identificador)
            ...
            Try
                ...
                If Existe Then
                    ...
                    If dr.Read() Then
                        Me.Descripcion = CStr(dr("T_DSC_FUNCION"))
    ...
    Public Function ObtenerSiguienteIdentificador() As Integer
        ...
        Try
            ...
            Dim dr As SqlClient.SqlDataReader = conexion.ConsultarDR("SELECT (MAX(N_ID_FUNCION) + 1) N_ID_FUNCION FROM " + Tabla)

            If dr.Read() Then

                If IsDBNull(dr("N_ID_FUNCION")) Then
                    resultado = 1
                Else
                    resultado = CInt(dr("N_ID_FUNCION"))
                End If
    ...
    Public Function Agregar() As Boolean
        ...
        Dim bitacora As New Conexion.Bitacora("Registro de nueva Función", System.Web.HttpContext.Current.Session.SessionID, CType(System.Web.HttpContext.Current.Session(Entities.Usuario.SessionID), Entities.Usuario).IdentificadorUsuario)
        ...
        Try
            ...
            listCampos.Add("N_ID_FUNCION") : listValores.Add(Me.Identificador)
            listCampos.Add("T_DSC_FUNCION") : listValores.Add(Me.Descripcion)
    ...
    Public Function Actualizar() As Boolean
        ...
        Dim conexion As New Conexion.SQLServer
        Dim bitacora As New Conexion.Bitacora("Actualización de Función", System.Web.HttpContext.Current.Session.SessionID, CType(System.Web.HttpContext.Current.Session(Entities.Usuario.SessionID), Entities.Usuario).IdentificadorUsuario)
        Try
            ...
            listCamposCondicion.Add("N_ID_FUNCION") : listValoresCondicion.Add(Me.Identificador)
    ...
    Public Function Baja() As Boolean
        ...
        Dim conexion As New Conexion.SQLServer
        Dim bitacora As New Conexion.Bitacora("Borrar Función", System.Web.HttpContext.Current.Session.SessionID, CType(System.Web.HttpContext.Current.Session(Entities.Usuario.SessionID), Entities.Usuario).IdentificadorUsuario)
        Try
