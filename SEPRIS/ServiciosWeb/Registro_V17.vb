...
Public Class Registro_V17
   ...
   Public Function registrarVisitaPadre(ByVal con As Conexion.SQLServer, ByVal tran As SqlClient.SqlTransaction) As Boolean
      ...
      Catch ex As Exception
         Utilerias.ControlErrores.EscribirEvento(ex.ToString(), EventLogEntryType.Error, "wcfRegistro_V17.csv.vb, registrarVisitaPadre", "")
         regExitoso = False
      End Try
   ...
   Public Function registrarPasoCero(ByVal con As Conexion.SQLServer, ByVal tran As SqlClient.SqlTransaction) As Boolean
      ...
      Try
         ...
         Paso.IdPaso = 1 ' 0 - Reunión con Vicepresidencia y VJ para vulnerabilidades
   ...
   Public Function registrarPasoUno(ByVal con As Conexion.SQLServer, ByVal tran As SqlClient.SqlTransaction) As Boolean
      ...
      Catch ex As Exception
         Utilerias.ControlErrores.EscribirEvento(ex.ToString(), EventLogEntryType.Error, "wcfRegistro_V17.csv.vb, registrarPasoUno", "")
         regExitoso = False
      End Try
   ...
   Public Function registrarEstatusPaso(ByVal con As Conexion.SQLServer, ByVal tran As SqlClient.SqlTransaction) As Boolean
      ...
      Try
        ...
        Catch ex As Exception
         Utilerias.ControlErrores.EscribirEvento(ex.ToString(), EventLogEntryType.Error, "wcfRegistro_V17.csv.vb, registrarEstatusPaso", "")
         regExitoso = False
      End Try
   ...
   Public Function InsertaUsuarios(IdentificadorUsuario As String, psSupervisor As String, psLstInspector As List(Of String)) As Boolean
      ...
      Try
         ...
         Next
      Catch ex As Exception
         Utilerias.ControlErrores.EscribirEvento(ex.ToString(), EventLogEntryType.Error, "wcfRegistro_V17.csv.vb, InsertaUsuarios", "")
         Return False
      End Try
