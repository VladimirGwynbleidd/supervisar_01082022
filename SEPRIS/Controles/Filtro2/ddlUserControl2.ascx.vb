Public Class ddlUserControl2
    ...
    Private _DataValueType As ucFiltro2.DataValueType
    Public Property DataValueType() As ucFiltro2.DataValueType
        Get
            Return _DataValueType
        End Get
        Set(ByVal value As ucFiltro2.DataValueType)
    ...
    Public Sub Bind()
        If _source IsNot Nothing Then
            If DataValueType = ucFiltro2.DataValueType.BoolType Then
                ddlData.DataBind()
            Else
