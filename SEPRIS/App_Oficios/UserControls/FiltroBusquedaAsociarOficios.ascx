<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="FiltroBusquedaAsociarOficios.ascx.vb"
    Inherits="SICOD.FiltroBusquedaAsociarOficios" %>
...
<body>
    <%--<asp:UpdatePanel ID="upnlControles" runat="server">
    <ContentTemplate>--%>
    <table>
        <tr>
            <td>
                <asp:Panel ID="pnlRangoDeFechas" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            <td width="180" align="left">
                                <asp:Label ID="lblPeriodo" CssClass="txt_gral_blanco" Height="19px" runat="server">Fecha Recepción Doc.:</asp:Label>
                            </td>
                            <td width="140" align="left">
                                <asp:TextBox ID="TxtFecRecIni" runat="server" Width="135px" MaxLength="12"></asp:TextBox>
                            ...
                            <td width="120" align="left">
                                <asp:TextBox ID="TxtFecRecFin" runat="server" Width="135px" MaxLength="12"></asp:TextBox>
                            ...
                            <td width="20">
                                <asp:Button ID="BtnEliminaRangoDeFechas" onmouseover="style.backgroundColor='#87100C'"
                                    onmouseout="style.backgroundColor='#BC6967'" runat="server" CssClass="botones_x"
                                    Text="x"></asp:Button>
                            </td>
                        </tr>
                    </table>
                ...
                <asp:Panel ID="pnlFechaDeDocto" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            ...
                            <td width="140" align="left">
                                <asp:TextBox ID="TxtFecDocto" runat="server" Width="135px"></asp:TextBox>
                            ...
                            <td align="left">
                                <asp:Image ID="imgFec1" runat="server" src="../imagenes/Calendar.gif" Style="cursor: hand" />
                            </td>
                            <td width="20">
                                <asp:Button ID="BtnEliminaFecDocto" onmouseover="style.backgroundColor='#87100C'"
                                    onmouseout="style.backgroundColor='#BC6967'" runat="server" CssClass="botones_x"
                                    Text="x"></asp:Button>
                            </td>
                        </tr>
                ...
                <asp:Panel ID="pnlFolio" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtFolio" runat="server" Width="135px" ToolTip="Numero de Folio"
                                    MaxLength="100"></asp:TextBox>
                            </td>
                            <td width="20">
                                <asp:Button ID="BtnEliminaFolio" onmouseover="style.backgroundColor='#87100C'" onmouseout="style.backgroundColor='#BC6967'"
                ...
                <asp:Panel ID="pnlTipoDeDocto" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="ddlTipoDocto" runat="server" Width="320px" AutoPostBack="true"
                                    CssClass="txt_gral">
                                </asp:DropDownList>
                            </td>
                            <td width="20">
                                <asp:Button ID="BtnEliminaTipoDocto" onmouseover="style.backgroundColor='#87100C'"
                                    onmouseout="style.backgroundColor='#BC6967'" runat="server" CssClass="botones_x"
                                    Text="x"></asp:Button>
                            </td>
                        </tr>
                ...
                <asp:Panel ID="pnlArea" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="ddlArea" runat="server" Width="320px" CssClass="txt_gral" AutoPostBack="True">
                                </asp:DropDownList>
                            </td>
                            <td width="20">
                                <asp:Button ID="BtnEliminaArea" onmouseover="style.backgroundColor='#87100C'" onmouseout="style.backgroundColor='#BC6967'"
                                    runat="server" CssClass="botones_x" Text="x"></asp:Button>
                            </td>
                        </tr>
                    </table>
                ...
                <asp:Panel ID="pnlDestinatario" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            ...
                            <td width="20">
                                <asp:Button ID="BtnEliminaDestinatario" onmouseover="style.backgroundColor='#87100C'"
                                    onmouseout="style.backgroundColor='#BC6967'" runat="server" CssClass="botones_x"
                                    Text="x"></asp:Button>
                            </td>
                        </tr>
                ...
                <asp:Panel ID="pnlReferencia" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="TxtRefere" runat="server" Width="320px" ToolTip="Descripcion Rerencia"
                                    MaxLength="50"></asp:TextBox>
                            </td>
                            <td width="20">
                                <asp:Button ID="BtnEliminaRefere" onmouseover="style.backgroundColor='#87100C'" onmouseout="style.backgroundColor='#BC6967'"
                                    runat="server" CssClass="botones_x" Text="x"></asp:Button>
                            </td>
                        </tr>
                    </table>
                ...
                <asp:Panel ID="pnlOficio" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtOficio" runat="server" Width="320px" ToolTip="Descripcion Oficio"
                                    MaxLength="100"></asp:TextBox>
                            </td>
                            <td width="20">
                                <asp:Button ID="BtnEliminaOficio" onmouseover="style.backgroundColor='#87100C'" onmouseout="style.backgroundColor='#BC6967'"
                                    runat="server" CssClass="botones_x" Text="x"></asp:Button>
                            </td>
                        </tr>
                    </table>
                ...
                <asp:Panel ID="pnlRemitente" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtRemitente" runat="server" Width="320px" ToolTip="Descripcion Remitente"
                                    MaxLength="100"></asp:TextBox>
                            </td>
                            <td width="20">
                                <asp:Button ID="BtnEliminaRemitente" onmouseover="style.backgroundColor='#87100C'"
                                    onmouseout="style.backgroundColor='#BC6967'" runat="server" CssClass="botones_x"
                                    Text="x"></asp:Button>
                            </td>
                        </tr>
                ...
                <asp:Panel ID="pnlAsunto" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtAsunto" runat="server" Width="320px" ToolTip="Descripcion de Asunto"
                                    MaxLength="100"></asp:TextBox>
                            </td>
                            <td width="20">
                                <asp:Button ID="BtnEliminaAsunto" onmouseover="style.backgroundColor='#87100C'" onmouseout="style.backgroundColor='#BC6967'"
                                    runat="server" CssClass="botones_x" Text="x"></asp:Button>
                            </td>
                        </tr>
                    </table>
                ...
                <asp:Panel ID="pnlNombre" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtNombre" runat="server" Width="320px" ToolTip="Nombre Usuario Responsable"
                                    MaxLength="100"></asp:TextBox>
                            </td>
                            <td width="20">
                                <asp:Button ID="BtnEliminaNombre" onmouseover="style.backgroundColor='#87100C'" onmouseout="style.backgroundColor='#BC6967'"
                                    runat="server" CssClass="botones_x" Text="x"></asp:Button>
                            </td>
                        </tr>
                    </table>
                ...
                <asp:Panel ID="pnlStatusAtendida" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            ...
                            <td width="20">
                                <asp:Button ID="BtnEliminaStatus" onmouseover="style.backgroundColor='#87100C'" onmouseout="style.backgroundColor='#BC6967'"
                                    runat="server" CssClass="botones_x" Text="x"></asp:Button>
                            </td>
                        </tr>
                    </table>
                ...
                <asp:Panel ID="pnlFechaRegistro" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            ...
                            <td width="140" align="left">
                                <asp:TextBox ID="txtFechaRegistro" runat="server" Width="135px"></asp:TextBox>
                            ...
                            <td align="left">
                                <asp:Image ID="imgFecReg" runat="server" src="../imagenes/Calendar.gif" Style="cursor: hand" />
                            </td>
                            <td width="20">
                                <asp:Button ID="BtnEliminaFechaRegistro" onmouseover="style.backgroundColor='#87100C'"
                                    onmouseout="style.backgroundColor='#BC6967'" runat="server" CssClass="botones_x"
                                    Text="x" Height="16px"></asp:Button>
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                ...
                <asp:Panel ID="pnlFechaLimite" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            ...
                            <td width="140" align="left">
                                <asp:TextBox ID="txtFechaLimite" runat="server" Width="135px"></asp:TextBox>
                            ...
                            <td align="left">
                                <asp:Image ID="imgFecLim" runat="server" src="../imagenes/Calendar.gif" Style="cursor: hand" />
                            </td>
                            <td width="20">
                                <asp:Button ID="BtnEliminaFechaLimite" onmouseover="style.backgroundColor='#87100C'"
                                    onmouseout="style.backgroundColor='#BC6967'" runat="server" CssClass="botones_x"
                                    Text="x"></asp:Button>
                            </td>
                        </tr>
                ...
                <asp:Panel ID="pnlEstatus" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            ...
                            <td width="20">
                                <asp:Button ID="BtnEliminaEstatus" runat="server" CssClass="botones_x" onmouseout="style.backgroundColor='#BC6967'"
                                    onmouseover="style.backgroundColor='#87100C'" Text="x" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                ...
                <asp:Panel ID="pnlProvieneSIE" Visible="False" runat="server">
                    <table border="0" cellspacing="0" width="670" class="filtroOficiosWrapper">
                        <tr>
                            ...
                            <td width="20">
                                <asp:Button ID="BtnEliminaSIE" runat="server" CssClass="botones_x" onmouseout="style.backgroundColor='#BC6967'"
                                    onmouseover="style.backgroundColor='#87100C'" Text="x" />
                            </td>
                        </tr>
                    </table>
        ...
        <tr>
            <td align="left">
                ...
                <asp:ListBox ID="listFiltrosControl" Visible="False" runat="server">
                    ...
                    <asp:ListItem Value="0">Remitente</asp:ListItem>
                    <asp:ListItem Value="0">Asunto</asp:ListItem>
                    <asp:ListItem Value="0">Responsable</asp:ListItem>
                    ...
                    <asp:ListItem Value="0">Proviene SIE</asp:ListItem>
                </asp:ListBox>
            </td>
        </tr>
    </table>
