...
#Region "Carga Datos"
    ...
    Private Sub CargarFiltros()
        ...
        ucFiltro1.AddFilter("ID", ucFiltro.AcceptedControls.TextBox, Nothing, "", "N_ID_FLUJO", ucFiltro.DataValueType.IntegerType, False, False, False, False, False, Nothing, 3)
        ucFiltro1.AddFilter("Flujo", ucFiltro.AcceptedControls.TextBox, Nothing, "", "T_DSC_FLUJO", ucFiltro.DataValueType.StringType, False, True)
        ucFiltro1.LoadDDL("CatalogoFlujo.aspx")
    ...
    Private Sub CargarCatalogo()
        ...
        Dim objFlujo As New Flujo
        Dim dv As DataView = objFlujo.ObtenerTodos()
...
#Region "Eventos Controles"
    ...
    Protected Sub btnAgregar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAgregar.Click
        ...
        lblTituloRegistro.Text = "Alta de Flujo"

        Dim objFlujo As New Flujo()

        txtID.Text = objFlujo.ObtenerSiguienteIdentificador.ToString
        txtFlujo.Text = String.Empty
    ...
    Protected Sub btnAceptar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAceptar.Click
        ...
        Dim objFlujo As New Flujo(Convert.ToInt32(txtID.Text))

        If Not objFlujo.Existe Then
            Dim errores As New Entities.EtiquetaError(1084)
            Mensaje = errores.Descripcion
            imgDosBotonesUnaAccion.ImageUrl = Entities.Imagen.RutaCarpeta & errores.Imagen.Ruta
        Else
            Dim errores As New Entities.EtiquetaError(1085)
            Mensaje = errores.Descripcion
            imgDosBotonesUnaAccion.ImageUrl = Entities.Imagen.RutaCarpeta & errores.Imagen.Ruta
        End If
    ...
    Protected Sub btnModificar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnModificar.Click
        ...
        lblTituloRegistro.Text = "Modificación de Flujo"

        If gvConsulta.SelectedIndex = -1 Then
            Dim errores As New Entities.EtiquetaError(1077)
            Mensaje = errores.Descripcion
        ...
        Dim objFlujo As New Flujo(CInt(gvConsulta.DataKeys(gvConsulta.SelectedIndex)("N_ID_FLUJO").ToString()))

        If Not objFlujo.Vigente Then
            Dim errores As New Entities.EtiquetaError(1078)
            Mensaje = errores.Descripcion
            imgUnBotonNoAccion.ImageUrl = Entities.Imagen.RutaCarpeta & errores.Imagen.Ruta
            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Mostraremos", "AquiMuestroMensaje();", True)
            Exit Sub
        Else
            txtID.Text = objFlujo.Identificador
            txtFlujo.Text = objFlujo.Descripcion
    ...
    Protected Sub btnEliminar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnEliminar.Click
        ...
        Dim errores
        If gvConsulta.SelectedIndex = -1 Then
            errores = New Entities.EtiquetaError(1077)
            Mensaje = errores.Descripcion
            imgUnBotonNoAccion.ImageUrl = Entities.Imagen.RutaCarpeta & errores.Imagen.Ruta
            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Mostraremos", "AquiMuestroMensaje();", True)
            Exit Sub
        ...
        If Not objFlujo.Vigente Then
            errores = New Entities.EtiquetaError(1078)
            Mensaje = errores.Descripcion
            imgUnBotonNoAccion.ImageUrl = Entities.Imagen.RutaCarpeta & errores.Imagen.Ruta
            ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "Mostraremos", "AquiMuestroMensaje();", True)
            Exit Sub
        ...
        errores = New Entities.EtiquetaError(1087)
        Mensaje = errores.Descripcion
        imgDosBotonesUnaAccion.ImageUrl = Entities.Imagen.RutaCarpeta & errores.Imagen.Ruta
    ...
    Protected Sub btnAceptarM2B1A_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAceptarM2B1A.Click
        ...
        Select Case btnAceptarM2B1A.CommandArgument
            ...
            Case "btnAceptar"
                ...
                Dim objFlujo As New Flujo(Convert.ToInt32(txtID.Text))
                objFlujo.Descripcion = txtFlujo.Text

                If Not objFlujo.Existe Then
                    objFlujo.Identificador = objFlujo.ObtenerSiguienteIdentificador()
                    objFlujo.Agregar()
                Else
                    objFlujo.Actualizar()
                End If
    ...
    Protected Sub btnConsulta_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnConsulta.Click
        ...
        lblTituloRegistro.Text = "Consulta de Flujo"

        Dim index As Integer = Convert.ToInt32(Request("__EVENTARGUMENT"))

        Dim objFlujo As New Flujo(CInt(gvConsulta.DataKeys(index)("N_ID_FLUJO").ToString()))

        txtID.Text = objFlujo.Identificador.ToString
        txtFlujo.Text = objFlujo.Descripcion
    ...
    Protected Sub btnExportaExcel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnExportaExcel.Click
        ...
        utl.ExportaGrid(dt, gvConsulta, "Catálogo de Flujo", referencias)
    End Sub
...
#Region "Validaciones"
    ...
    Private Sub cvTipoFlujo_ServerValidate(ByVal source As Object, ByVal args As System.Web.UI.WebControls.ServerValidateEventArgs) Handles cvFlujo.ServerValidate
        If txtFlujo.Text.Trim() = String.Empty Then
            Dim errores As New Entities.EtiquetaError(1079)
