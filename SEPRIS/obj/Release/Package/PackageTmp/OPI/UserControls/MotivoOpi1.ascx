<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="MotivoOpi1.ascx.vb" Inherits="SEPRIS.MotivoOpi1" %>
            ...
            <table style="width: 95%">
                <tr runat="server" clientidmode="Static">
                    ...
                    <td style="text-align: left;" class="auto-style2" rowspan="2">
                        <asp:TextBox ID="txtMotivo1" runat="server" onkeypress="ReemplazaCEspeciales(this.id)"
