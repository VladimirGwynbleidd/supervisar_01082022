<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/SiteInterno.Master" CodeBehind="CatalogoTipoImagen.aspx.vb" Inherits="SEPRIS.CatalogoTipoImagen" %>
    ...
    <asp:UpdatePanel ID="upnlConsulta" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlConsulta" runat="server" Visible="true">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <label class="TitulosWebProyectos">
                        Catálogo de Tipo de Imagen</label>
                </div>
                ...
                <br />
                <cc1:CustomGridView ID="gvConsulta" AllowSorting="True" runat="server" DataKeyNames="N_ID_TIPO_IMAGEN"
                    ...
                    UnicoEnPantalla="True" WidthScroll="0">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                        ...
                        <asp:BoundField HeaderText="ID" DataField="N_ID_TIPO_IMAGEN" 
                            SortExpression="N_ID_TIPO_IMAGEN" >
                            <ItemStyle Width="50px" />
                            <HeaderStyle Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Descripción" DataField="T_DSC_TIPO_IMAGEN" SortExpression="T_DSC_TIPO_IMAGEN" />
            ...
            <asp:Panel ID="pnlRegistro" runat="server" Visible="false">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <asp:Label ID="lblTituloRegistro" runat="server" CssClass="TitulosWebProyectos" Text="Alta de Tipo de Imagen" EnableTheming="false"></asp:Label>
                </div>
                <asp:Panel ID="pnlControles" runat="server">
                    <table>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtTipoImagen" runat="server" CssClass="txt_gral" Width="300px"
                                    ValidationGroup="Forma" MaxLength="50"></asp:TextBox>
                                <asp:CustomValidator ID="cvTipoImagen"
                                        ControlToValidate="txtTipoImagen" ValidationGroup="Forma" ValidateEmptyText="true"
