<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucFiltro.ascx.vb" Inherits="SEPRIS.ucFiltro" %>
    ...
    <table width="100%">
        <tr>
            ...
            <td  style="text-align: left" class="MensajeModal-UI">
                <label id="MensajeVericficaFiltro"></label>
            </td>
        </tr>
    </table>
</div>
...
<script type="text/javascript">
    ...
    function MuestraVerificacionFiltro(mensaje) {
        debugger;
        MensajeVerificaFiltroAsignaMensaje(mensaje);
        return false;
    }
    ...
    function MensajeVerificaFiltroAsignaMensaje(mensaje) {
        $('#MensajeVericficaFiltro').text(mensaje);
