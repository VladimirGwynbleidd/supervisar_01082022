<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/SiteInterno.Master"
    CodeBehind="CatalogoMenuPerfil.aspx.vb" Inherits="SEPRIS.CatalogoMenuPerfil" %>
            ...
            <asp:Panel ID="pnlConsulta" runat="server" Visible="true">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <label class="TitulosWebProyectos">
                        Catálogo Perfiles de Menú</label>
                </div>
                <br />
                <table align="center">
                    <tr>
                        <td>
                            <asp:Label ID="lblPerfil" runat="server" Text="Perfil:" CssClass="txt_gral"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlPerfil" runat="server" AutoPostBack="true" CssClass="txt_gral"
                                Width="200px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlMenu" runat="server" AutoPostBack="true" CssClass="txt_gral"
                                Width="200px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    ...
                    <table align="center">
                        <tr>
                            <td valign="top" style="width: 300px;">
                                ...
                                <asp:Label ID="lblUsados" runat="server" Text="Submenús actualmente usados por el menú"
                            ...
                            <td valign="top" style="width: 300px;">
                                ...
                                <asp:Label ID="lblDisponibles" runat="server" Text="Submenús disponibles para agregar"
                                    CssClass="txt_gral"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top">
                                <div id="serviciosAgregados" style="text-align: left; vertical-align: top;">
                                    <cc1:CustomGridView ID="gvUsados" runat="server" Width="100%" SkinID="SeleccionMultipleCliente"
                                        HabilitaScroll="true" HeigthScroll="400" WidthScroll="320" UnicoEnPantalla="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Clave" DataField="IdentificadorSubMenu" />
                                            <asp:BoundField HeaderText="Submenú" DataField="Descripcion" />
                                        </Columns>
                                    </cc1:CustomGridView>
                            ...
                            <td valign="top">
                                <div id="Div1" style="text-align: left; vertical-align: top;">
                                    <cc1:CustomGridView ID="gvDisponibles" runat="server" Width="100%" SkinID="SeleccionMultipleCliente"
                                        HabilitaScroll="true" HeigthScroll="450" WidthScroll="320" UnicoEnPantalla="false"
                                        ToolTipHabilitado="false">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
