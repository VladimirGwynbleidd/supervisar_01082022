<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/SiteInterno.Master" CodeBehind="CorreosPerfil.aspx.vb" Inherits="SEPRIS.CorreosPerfil" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlConsulta" runat="server" Visible="true">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <label class="TitulosWebProyectos" enabletheming="false">Catálogo Correos de Perfil</label>
                </div>
                <br />
                <table align="center">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlArea" runat="server" AutoPostBack="true"  CssClass="txt_gral" Width="200px">
                            </asp:DropDownList>
                            <asp:CustomValidator ID="CustomValidator1" ControlToValidate="ddlArea" ValidationGroup="Forma" ValidateEmptyText="true"
                                runat="server" EnableClientScript="false" Display="Dynamic" ForeColor="Red">*</asp:CustomValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="txt_gral">
                            <asp:Label ID="lbPerfil" runat="server" Visible="false" Text="Perfil:"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlPerfil" runat="server" AutoPostBack="true" Visible="false" CssClass="txt_gral" Width="200px">
                            </asp:DropDownList>
                    ...
                    <table align="center">
                        <tr>
                            <td valign="top" style="width: 300px;">
                                ...
                                <asp:Label ID="lblAsignados" runat="server" Text="Correos asignados al perfil" CssClass="txt_gral" ></asp:Label>
                            </td>
                            <td>
                                &nbsp;
                            </td>
                            <td valign="top" style="width: 300px;">
                                ...
                                <asp:Label ID="lblDisponibles" runat="server" Text="Correos disponibles" CssClass="txt_gral"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" style="width: 300px;">                                                                
