Public Class rbUserControlOficios
    ...
    Private Sub ucRadioButton_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ucRadioButton.SelectedIndexChanged
        FetchValues()
    End Sub
