<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/SiteInterno.Master" CodeBehind="CopiaCorreoUsuario.aspx.vb" Inherits="SEPRIS.CopiaCorreoUsuario" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlConsulta" runat="server" Visible="true">
                <div align="center" style="padding: 20px 20px 15px 20px">
                    <label class="TitulosWebProyectos" enabletheming="false">Catálogo Copia de Correos</label>
                </div>
                <br />
                <table align="center">
                    <tr>
                    ...
                    <table align="center">
                        <tr>
                            <td valign="top" style="width: 300px;">
                                ...
                                <asp:Label ID="lblAsignados" runat="server" Text="Copias de correos asignados al Usuario" CssClass="txt_gral" ></asp:Label>
                            </td>
                            <td>
                                &nbsp;
                            </td>
