Public Class ddlUserControl3
    ...
    Private _DataValueType As ucFiltro3.DataValueType
    Public Property DataValueType() As ucFiltro3.DataValueType
        Get
            Return _DataValueType
        End Get
        Set(ByVal value As ucFiltro3.DataValueType)
    ...
    Public Sub Bind()
        If _source IsNot Nothing Then
            If DataValueType = ucFiltro3.DataValueType.BoolType Then
                ddlData.DataBind()
            Else
