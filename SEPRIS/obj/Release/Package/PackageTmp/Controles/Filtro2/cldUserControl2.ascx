<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="cldUserControl2.ascx.vb"
    Inherits="SEPRIS.cldUserControl2" %>
    ...
    <tr>
        ...
        <td class="ucfilter_btnclose">
            <div style="width: 25px">
                <asp:Button ID="btnDelete" runat="server" SkinID="botones_x" Text="x"></asp:Button>
            </div>
        </td>
    </tr>
</table>
