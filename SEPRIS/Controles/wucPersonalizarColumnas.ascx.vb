Public Class wucPersonalizarColumnas
    ...
    Public Sub Personalizar()
        ...
        If columnasAsignados.Any Then
            ...
            For Each columna As Entities.PersonalizarColumnas.Columnas In columnasAsignados
                ...
                For contPerzonalizada = 1 To GridViewActual.Columns.Count - 1

                    If columna.Texto.Trim.ToUpper = GridViewActual.Columns(contPerzonalizada).HeaderText.Trim.ToUpper Then

                        GridViewActual.Columns(contPerzonalizada).Visible = True
            ...
            For Each columna As Entities.PersonalizarColumnas.Columnas In columnasNoAsignados
                ...
                For contPerzonalizada = 1 To GridViewActual.Columns.Count - 1
                    ...
                    If columna.Texto.Trim.ToUpper = GridViewActual.Columns(contPerzonalizada).HeaderText.Trim.ToUpper Then
                        ...
                        GridViewActual.Columns(contPerzonalizada).Visible = False
